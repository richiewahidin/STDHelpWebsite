...
const CountiesInstance = () => {
    ...
    const { id, name, population, ccases, gcases, scases, escases, tscases, udcases, mapurl, flagurl, countyseat} = location.state;
        ...
        <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', width: '100%' }}>
                <div style={{ flex: '0 0 60%', marginBottom: '20px' }}>
                    <h3 style={{ fontSize: '1.5rem', marginBottom: '10px' }}> County Seat: {instanceCounties.countyseat} </h3>
